...
clusterapi_version   = "<1.x.y>"		  # defaults to "1.5.1" of kubernetes-sigs/cluster-api on github-releases
capi_openstack_version = "<0.x.y>"		  # defaults to "0.7.3" of kubernetes-sigs/cluster-api-provider-openstack
